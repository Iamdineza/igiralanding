...
import { TestimonialHeading, TestimonialMarquee } from '@/components/testimonial-marquee'
...
function TestimonialsSection() { return <section className="section testimonials-section" aria-labelledby="testimonials-title"><div className="container"><Reveal className="section-heading"><TestimonialHeading /></Reveal><TestimonialMarquee /></div></section> }
