...
function HowItWorks() { const steps = [['01', 'Learn', 'Understand traffic rules, road signs and driving concepts.'], ['02', 'Practice', 'Test your knowledge using practice questions.'], ['03', 'Prepare', 'Take timed mock tests and prepare for the theory test.']]; return <section className="section how-section" id="how-it-works"><div className="container"><Reveal className="section-heading"><Pill>THE METHOD</Pill><h2>Your preparation starts here.</h2><p>A simple, focused path from uncertainty to confidence on the road.</p></Reveal><div className="steps-grid">{steps.map(([num, title, copy]) => <Reveal className="step" key={num}><span className="step-number">{num}</span><h3>{title}</h3><p>{copy}</p></Reveal>)}</div></div></section> }
